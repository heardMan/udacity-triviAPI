...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_post_question(self):
        ...
        #make sure the initial number of questions is greater than the number of question after the POST
    ...
    def test_delete_questions(self):
        ...
        #make sure the initial number of questions is greater than the number of question after the DELETE
    ...
    def test_search_questions(self):
        ...
        self.assertEqual(post.status_code, 200)
        self.assertEqual(post_data['success'], True)
        #make sure the initial number of questions is greater than the questions restricted by a search term
        self.assertGreater(init_question_num, final_question_num)
    ...
    def test_get_questions_by_category(self):
        ...
        self.assertEqual(post.status_code, 200)
        self.assertEqual(post_data['success'], True)
        #make sure the initial number of questions for all categories is greater than the questions for a single category
        self.assertGreater(init_question_num, final_question_num)
